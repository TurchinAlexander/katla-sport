...
namespace KatlaSport.Services
{
    ...
    public class DependencyRegistrationModule : Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<ProductManagement.ProductStoreService>().As<ProductManagement.IProductStoreService>();
            builder.RegisterType<ProductManagement.ProductStoreRequestService>().As<ProductManagement.IProductStoreRequestService>();
            builder.RegisterType<HiveManagement.HiveService>().As<HiveManagement.IHiveService>();
